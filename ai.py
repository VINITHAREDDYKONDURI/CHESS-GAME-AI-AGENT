...
class AI:
    ...
    try:
        cache = open('C:/Users/vinit/PycharmProjects/CHESSAIPROJECT/ai project/data/cache.p', 'rb')
    except IOError:
        cache = open('C:/Users/vinit/PycharmProjects/CHESSAIPROJECT/ai project/data/cache.p', 'wb')
    ...
    def ai_move(self):
        ...
        with open('C:/Users/vinit/PycharmProjects/CHESSAIPROJECT/ai project/data/cache.p', 'wb') as cache:
